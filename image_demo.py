...
class COCODemo(object):
    ...
    def overlay_mask(self, image, predictions):
        ...
        for mask, color in zip(masks, colors):
            thresh = mask[0, :, :, None]
            cv2.imwrite('/home/zst19phu/benchmark/benchmark-code/datasets/edd2020/image.jpg', thresh) 
            contours, hierarchy = cv2_util.findContours(
                thresh, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE
            )
            
            image = cv2.drawContours(image, contours, -1, color, 10)
    ...
    def overlay_class_names(self, image, predictions):
        ...
        for box, score, label in zip(boxes, scores, labels):
            ...
            cv2.putText(
                image, s, (x, y), cv2.FONT_HERSHEY_SIMPLEX, .90, (255, 255, 255), 1
            )
...
config_file = "/home/zst19phu/benchmark/benchmark-code/eddcode/test28feb.yaml"
...
#matplotlib.use('QT5Agg')
# #In[ ]:#
#val_path="/home/zst19phu/benchmark/benchmark-code/datasets/edd2020/eddval2020/" #this is the validation image data

val_path="/home/zst19phu/benchmark/benchmark-code/eddcode/paper/"
...
for name in imglistval:
    ...
    #save_path='/home/zst19phu/benchmark/benchmark-code/datasets/edd2020/eddvaloutput/'
    save_path='/home/zst19phu/benchmark/benchmark-code/eddcode/paper/'
    ...
    plt.savefig(save_path+name+'.tif',dpi=100)
