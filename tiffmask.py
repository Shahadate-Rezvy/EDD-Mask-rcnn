...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 24 16:11:18 2020
...
def get_args():
    ...
    # test data
    parser.add_argument("--maskDir", type=str, default="/home/zst19phu/benchmark/benchmark-code/eddcode/shah_eddout", help="ground truth single channel image (to 5 channel tif image only)")
    parser.add_argument("--orginalImageDir", type=str, default="/home/zst19phu/benchmark/benchmark-code/eddcode/input", help="original image")
    parser.add_argument("--compositeImageDir", type=str, default="/home/zst19phu/benchmark/benchmark-code/eddcode/scompositeMask/", help="combined tiff")
