...
#https://code.ihub.org.cn/projects/578/repository/revisions/master/entry/maskrcnn_benchmark/engine/inference.py
        ...
        for mask, label in zip(masks,labels):
            ...
            if  label == "BE":
              ...
              image = cv2.drawContours(image, contours, -1, (0,222,0), 2)
              
            elif  label == "HGD":
              image = cv2.drawContours(image, contours, -1, (120,20,120), 3)
              
            elif  label == "cancer":
              image = cv2.drawContours(image, contours, -1, (255, 0, 0), 6)
              
            elif  label == "polyp":
              image = cv2.drawContours(image, contours, -1, (255, 2555, 0), 6)
...
#matplotlib.use('QT5Agg')
# #In[ ]:#
val_path="/home/zst19phu/benchmark/benchmark-code/eddcode/paper/" #this is the validation image data
