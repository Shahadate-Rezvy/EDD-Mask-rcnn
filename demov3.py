...
#https://code.ihub.org.cn/projects/578/repository/revisions/master/entry/maskrcnn_benchmark/engine/inference.py
        ...
        for mask, label in zip(masks,labels):
            ...
            if  label == "BE":
              ...
              (thresh, BE) = cv2.threshold(BE_gray, 10, 255, cv2.THRESH_BINARY | cv2.THRESH_OTSU)
              ...
              (thresh, S) = cv2.threshold(S_gray, 10, 255, cv2.THRESH_BINARY | cv2.THRESH_OTSU)
              ...
              (thresh, H) = cv2.threshold(H_gray, 10, 255, cv2.THRESH_BINARY | cv2.THRESH_OTSU)
              ...
              (thresh, C) = cv2.threshold(C_gray, 10, 255, cv2.THRESH_BINARY | cv2.THRESH_OTSU)
              ...
              (thresh, P) = cv2.threshold(P_gray,10, 255, cv2.THRESH_BINARY| cv2.THRESH_OTSU )
...
config_file = "/home/zst19phu/benchmark/benchmark-code/eddcode/etest2.yaml"
...
for name in imglistval:
    ...
    save_path='/home/zst19phu/benchmark/benchmark-code/datasets/edd2020/eddout/'
